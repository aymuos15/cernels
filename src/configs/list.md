...
| [rotary](registry/rotary.py) | [kernels-community/rotary](https://huggingface.co/kernels-community/rotary) | [apply_rotary_pos_emb](https://github.com/huggingface/transformers/blob/main/src/transformers/models/llama/modeling_llama.py) | apply_rotary_transformers | [rope](../kops/rope.py) |
