...
grid_sample semantics: align_corners=False, padding_mode=zeros; px = loc_x*W - 0.5 (the
custom kernel matches torch's convention exactly via this formula).
"""
...
from kops.registry.multi_scale_deformable_attention import kernel as deform_attn_kernel


class MultiScaleDeformableAttention(Config):
